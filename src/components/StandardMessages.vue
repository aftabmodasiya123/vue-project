            ...
            <v-row no-gutters class="ma-0 pa-0">
                <v-col>
                    <v-data-table :headers="headers"
                        ...
                        <template v-slot:top>
                            <v-toolbar flat>
                                <v-toolbar-title>Standard Messages</v-toolbar-title>
                                                ...
                                                <v-row>
                                                    <v-col cols="12">
                                                        <v-text-field v-model="editedItem.fields.text"
                                                                      label="Message Text"></v-text-field>
                                                    </v-col>
                                                </v-row>
                                            </v-container>
                                            <v-alert border="top"
    ...
    export default {
        ...
        methods: {
            ...
            setMessage(id, message) {
                try {
                    this.errorMessages = {};
                    this.dataAccess.setStandardMessage(id, message).then(() => {
                        this.getMessages(id);
            ...
            deleteMessage(id, pk) {
                try {
                    this.dataAccess.deleteStandardMessage(id, pk).then(() => {
                        this.getMessages(id);
                    });
                } catch (error) {
                    this.items = [];
            ...
            deleteItemConfirm() {
                this.deleteMessage('standard', this.items[this.editedIndex]['pk'])
            ...
            save() {
                ...
                this.setMessage('standard', this.editedItem);
            },
            isEmpty() {
